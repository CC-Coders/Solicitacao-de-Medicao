function beforeTaskSave(colleagueId,nextSequenceId,userList){
    ...
    if (hAPI.getCardValue("countBeforeTaskSave") == 0) {
        ...
        if (atividade == 0 || atividade == 4 || atividade == 54 || atividade == 5) {//Se atividade inicio
        ...
        if (atividade == 16 && decisao ==  "Aprovar" && (superior == "" || superior == null)) {//Se engenheiro aprova
            aprovaMov();
        }
        else if(atividade == 17 && decisao == "Aprovar" && (diretoria == "" || diretoria == null)){//Se superior aprova
            aprovaMov();
        }
        else if(atividade == 18 && decisao == "Aprovar"){//Se diretor aprova
            aprovaMov();
        }
    
        if ((atividade == 5 || atividade == 16 || atividade == 10 || atividade == 17 || atividade == 18 || atividade == 54) && (decisao != "Aprovar")) {//Se não aprovou verifica se complemento foi incluido
